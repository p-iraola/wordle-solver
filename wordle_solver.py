...
while True:
	...
	if answer2 == 'y':
		...
		must_haves = []
		first = input('\nEnter first letter, or leave blank: ').strip()
		if first:
			must_haves.append(first)

		second = input('Enter second letter, or leave blank: ').strip()
		if second:
			must_haves.append(second)

		third = input('Enter third letter, or leave blank: ').strip()
		if third:
			must_haves.append(third)

		fourth = input('Enter fourth letter, or leave blank: ').strip()
		if fourth:
			must_haves.append(fourth)

		fifth = input('Enter fifth letter, or leave blank: ').strip()
		if fifth:
	...
	#Checking if right and reset or ending loop
